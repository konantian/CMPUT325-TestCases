...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(test-case '5.1.1
    (poly-add '((5 . 2)) '((-5 . 2))) NIL
)

(test-case '5.1.2
    (poly-add '((5 . 2) (-5 . 2)) '((1 . 2))) '((1 . 2))
)

(test-case '5.1.3
    (poly-add '((5 . 2) (-5 . 2)) '((0 . 0))) NIL
)

(test-case '5.1.4
    (poly-add '((5 . 2) (-3 . 2)) '((-2 . 2))) NIL
)

(test-case '5.1.5
    (poly-add '((5 . 2) (-3 . 2)) '((-1 . 2) (3 . 2))) '((4 . 2))
)

; poly-subtract test cases starts from 5.1.10
(test-case '5.1.10
    (poly-subtract '((1 . 2)) '((-1 . 2))) '((2 . 2))
)

(test-case '5.1.11
    (poly-subtract '((1 . 2) (2 . 2)) '((-1 . 2))) '((4 . 2))
)

(test-case '5.1.12
    (poly-subtract '((0 . 2) (2 . 2)) '((3 . 2))) '((-1 . 2))
)

(test-case '5.1.13
    (poly-subtract '((0 . 2) (0 . 2)) '((0 . 2))) NIL
)
